...
2. **2D pose estimation introduces systematic errors** due to perspective projection — a person facing sideways has foreshortened limbs that distort angle measurements.
3. **3D pose estimation** (lifting 2D keypoints to 3D) significantly improves angle accuracy but adds complexity and latency.
4. **Temporal averaging** of angles (over 5–10 seconds) reduces noise and improves score stability without affecting clinical relevance.
5. **Camera viewing angle matters.** Frontal and 45° views provide the best angle estimates; top-down views are nearly useless for ergonomic assessment.
...
|------------|-----------|-----------------|-----------------|
| Nose       | ✓         | Neck estimation | Neck estimation |
| Eyes (L/R) | ✓         | Head orientation| Head orientation|
| Ears (L/R) | ✓         | Head orientation| Head orientation|
| Shoulders  | ✓         | ✓ Upper arm     | ✓ Trunk, arms  |
| Elbows     | ✓         | ✓ Lower arm     | ✓ Lower arm    |
| Wrists     | ✓         | ✓ Wrist         | ✓ Wrist        |
| Hips       | ✓         | ✓ Trunk angle   | ✓ Trunk angle  |
| Knees      | ✓         | —               | ✓ Leg score    |
| Ankles     | ✓         | —               | ✓ Leg score    |
...
2. Manually score RULA and REBA using standard worksheets.
3. Simultaneously capture video from the monitoring cameras.
4. Compare the automated scores with the manual expert scores.
...
|---------------------------------|-----------|-----------|-----------------------|
| Standing upright, arms at sides | 1–2       | 1–2       | High                  |
...
| Seated computer work            | 3–4       | 3–4       | High (office areas)   |
...
|-----------------------------------------------|------------|----------|------------------------------------------------------|
| Inaccurate angles from camera perspective     | High       | High     | View correction, recommend 45° camera angle         |
| Heavy PPE obscures body shape/joints          | High       | Medium   | Fine-tune pose model on PPE-wearing workers         |
| Multiple workers overlapping                  | Medium     | Medium   | Per-person tracking, reject low-confidence poses    |
| Worker facing away from camera                | Medium     | High     | Use bilateral keypoint visibility; flag "rear view" |
| RULA/REBA score disagrees with expert         | Medium     | Medium   | Continuous validation program with ergonomist       |
