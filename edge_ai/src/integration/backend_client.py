...
class BackendClient:
	...
	def __init__(
		...
		*,
		...
		Args:
			config: Optional override for runtime configuration.
			session: Optional requests session for dependency injection/tests.
		...
		Failure Behavior:
			Never raises on DB initialization failures; errors are logged and
			offline queue operations become no-op fallbacks.
		"""
	...
	def _init_db(self) -> None:
		# Create offline queue table if needed.
